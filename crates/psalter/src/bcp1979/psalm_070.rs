    ...
    pub static ref PSALM_70: Psalm = Psalm {
        ...
        sections: vec![
          PsalmSection {
              ...
              local_name: String::from("Psalm 70"),
              ...
              verses: vec![
                ...
                PsalmVerse {
                      number: 2,
                      a: String::from("Let those who seek my life be ashamed\nand altogether dismayed; *"),
                      b: String::from("let those who take pleasure in my misfortune\n draw back and be disgraced.")
                  },
                PsalmVerse {
                      number: 3,
                      a: String::from("Let those who say to me “Aha!” and gloat over me turn back, *"),
                      b: String::from("because they are ashamed.")
                  },
                PsalmVerse {
                      number: 4,
                      a: String::from("Let all who seek you rejoice and be glad in you; *"),
                      b: String::from("let those who love your salvation say for ever,\n “Great is the LORD!”")
                  },
                PsalmVerse {
                      number: 5,
